...
(async () => {
  ...
  await fs.writeFile("infection-of-skin-and-subcutaneous-tissues-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("infection-of-skin-and-subcutaneous-tissues-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
